...
#' @param response a numeric, factor, or logical vector containing
#'   label values.
#'
#'
...
label_for_survival <- function(time, status){
...
#' @rdname label_for_survival
#' @export
label_for_multi <- function(response){
...
#' @rdname label_for_survival
#' @export
label_for_binary <- function(response){
...
get_mgb_status_vals <- function(mgb_surv_label){
...
get_mgb_time_vals <- function(mgb_surv_label){
