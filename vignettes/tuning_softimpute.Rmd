...
soft_imputes <- trn %>%
  ...
  soft_fill(new_data = trn)

```

## Standard approach

A traditional approach to develop a predictive model with linear regression is to impute missing values of continuous variables using the mean observed value. 
...
ref_imp <- trn %>% map_dfc(.f = mean_imputer)
